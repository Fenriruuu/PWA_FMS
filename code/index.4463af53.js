 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var ve=class extends At{constructor(){super(...arguments);this.hasSlotController=new $n(this,"footer","header","image")}render(){return Pe`
      <div
        part="base"
...
`,be=class extends At{constructor(){super(...arguments);this.localize=new kn(this)}render(){return Pe`
...
`;var Fi=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor,Tn=(e,t,r,n)=>{for(var o=n>1?void 0:n?Wi(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(n?s(t,r,o):s(o))||o);return n&&o&&Fi(t,r,o),o};let _e=class extends V{constructor(){super();this.message="Welcome!"}static get styles(){return[zi,Ht`
    ...
    `]}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"PWABuilder pwa-starter",text:"Check out the PWABuilder pwa-starter!",url:"https://github.com/pwa-builder/pwa-starter"})}render(){return mt`
      ...
      <main>
        <div id="welcomeBar">
          ...
          <sl-button href="${"/PWA_FMS/"}about" variant="primary">Navigate to About</sl-button>
        </div>
    ...
    `}render(){return mt`
      <header>
        ...
        <div id="back-button-block">
          ${this.enableBack?mt`<sl-button href="${"/PWA_FMS/"}">
            Back
          </sl-button>`:null}
    ...
    `}constructor(){super()}firstUpdated(){var t;new H((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/PWA_FMS/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await Vn(()=>import("./app-about.014939cb.js"),[])}}]}])}render(){return mt`
      <div>
        <main>
...
//# sourceMappingURL=index.4463af53.js.map
